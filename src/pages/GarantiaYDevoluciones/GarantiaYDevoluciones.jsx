  ...
  return (
    <div className={styles.StaticPages}>
      ...
      <p>-Para cambiar un producto SIN defectos (producto diferente al que se solicitó):
          ...
          -Para cambiar un producto CON defectos:
      ...
      <p>
      Conforme lo establece el art. 34 de la ley 24.240 de Defensa del Consumidor, en concordancia con el artículo 1.111 y 1.112 del Código Civil y Comercial de la República Argentina el usuario tendrá también 10 días contados a partir de que se entregue el bien o se celebre el contrato para poder revocar la aceptación de la compra. Si así lo decidiera se aplica lo dispuesto por el art. 10 ter de la Ley 24.240 de Defensa del Consumidor. En tal caso, el usuario deberá reintegrar el producto comunicándose con el sitio para solicitar el retiro del producto, el cual deberá estar sin uso y en perfecto estado, con sus etiquetas, envoltorios y todos los accesorios adicionales que pudieren corresponder
      </p>
      <h2>Política de Garantía</h2>
      <p>Todos los productos comercializados en Computahorra tienen diez (10) días corridos de cambio directo por fallas y/o desperfectos, debiendo presentar la factura de compra original y el producto con su respectivo embalaje etiquetas y accesorios en perfecto estado. 
        Dentro de los 10 días corridos 
        Verificada la falla del producto se procederá según el caso:
        Enviar al cliente un nuevo producto 
        Se le devuelve el dinero
        Se le envía otro producto, abonando o devolviendo la diferencia
        Los costos de logística (restitución a Computahorra y al cliente) y de los productos con superioridad de condiciones serán asumidos por Computahorra.
        En el caso de NOTEBOOKS e IMPRESORAS en primera instancia se deberá comunicar con la marca, quien le proveerá un número de caso para dirigirse con el mismo a nuestro local.
        Vencido el plazo de diez días, todos los productos cuentan con garantía oficial del fabricante, debiendo ser gestionada por el cliente con la marca correspondiente. 
        ...
        Si el producto NO presenta falla, el cliente deberá abonar el costo del envío al domicilio del cliente.</p>
        Pasados los 10 días Corridos y dentro de los días establecidos por las políticas de cada marca, el envío de productos con falla a Computahorra será a cargo del cliente, sin excepción. 
        Los costos de gestión de garantías con proveedores estarán a cargo de Computahorra.
        Verificada la falla del producto se procederá según el caso:
        Enviar al cliente el producto reparado o uno nuevo en caso de no poder repararse
        Sólo para casos en que el producto no se reparó. Devolución de dinero a valores actualizados a la fecha de reclamo. En caso que sea imposible reparar o enviar un producto de similares características
        Los costos de envío del producto a Computahorra serán a cargo del Cliente y los costos de restitución del producto al cliente serán a cargo de Computahorra.
